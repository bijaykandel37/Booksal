...
define('global_mysql_user', 'bijay');
define('global_mysql_password', '');
define('global_mysql_database', 'booksalfinal');
...
define('global_url', 'localhost/onlinebooksal');
