...
.main-navi li a:hover
{
	...
	<body>
		...
		<header>
                            ...
                            if(isset($_SESSION["user_id"])){
                                ...
                                echo '<div class="dropdownn">
                                  ...
                                  <div class="dropdownn-content">
                                    <a href="../userprofile.php" data-toggle="modal" data-target="#profile"><i class="fa fa-user-circle" aria-hidden="true" ></i>My Profile</a>
			...
			<!-- MAIN HEADER -->
			<div id="header" style="max-height:150px;  padding-top: 0px;">
				<!-- container -->
				<div class="container" style="max-height:100px;">
                    ...
                    <div class="row" style="max-height:20px;margin-top:0px; padding-top:0px;" >
                        <div class="col-md-12" style="margin-top:0px; padding-top:0px;">
                    <ul class="main-navi" style="height:50px;margin-top:0px; padding-bottom:0px;">
...
<h2><?php 
    ...
    if (!$con) { die("Connection failed: " . mysqli_connect_error()); }
		...
		if (mysqli_num_rows($result) > 0) 
		{
          ...
          {
              echo '<a href="../futsal.php?p='.$futsalid.'">'.$row["futsal_name"].'</a>';
          }
        } ?> </h2><br>
