              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                        $result=mysqli_query($con,"select reservation_id, futsal_name, first_name, mobile, email, city,reservation_day ,reservation_time from reservations,futsals,user_info where reservations.futsal_id=futsals.futsal_id and user_info.user_id=reservations.reservation_user_id Limit $page1,10")or die ("query 1 incorrect.....");
